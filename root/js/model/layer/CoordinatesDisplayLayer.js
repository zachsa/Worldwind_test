...
define([
    ...
    function (ArgumentError,
        ...
        var CoordinatesDisplayLayer = function (worldWindow) {
            ...
            // Intentionally not documented.
            this.headingText = new ScreenText(new Offset(WorldWind.OFFSET_PIXELS, 0, WorldWind.OFFSET_PIXELS, 0), " ");
            this.headingText.attributes = new TextAttributes(null);
            this.headingText.attributes.color = Color.YELLOW;

            // Intentionally not documented.
            this.tiltText = new ScreenText(new Offset(WorldWind.OFFSET_PIXELS, 0, WorldWind.OFFSET_PIXELS, 0), " ");
            this.tiltText.attributes = new TextAttributes(null);
            this.tiltText.attributes.color = Color.YELLOW;
        ...
        CoordinatesDisplayLayer.prototype.doRender = function (dc) {
            ...
            // x += 110;
            // this.headingText.text = "Heading " + formatter.formatAngle180(this.wwd.navigator.heading,2);
            // this.headingText.screenOffset = new Offset(WorldWind.OFFSET_PIXELS, x, yUnitsScreen, y);
            // this.headingText.attributes.offset = new Offset(WorldWind.OFFSET_FRACTION, 1, WorldWind.OFFSET_FRACTION, yUnitsText);
            // this.headingText.render(dc);

            x += 90;
            this.tiltText.text =  formatter.formatAngle180(this.wwd.navigator.tilt,2)+ " (tilt)";
            this.tiltText.screenOffset = new Offset(WorldWind.OFFSET_PIXELS, x, yUnitsScreen, y);
            this.tiltText.attributes.offset = new Offset(WorldWind.OFFSET_FRACTION, 1, WorldWind.OFFSET_FRACTION, yUnitsText);
