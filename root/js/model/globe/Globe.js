...
define([
        ...
        'model/util/WmtUtil',
        'model/Config',
        'model/layer/CoordinatesDisplayLayer',
        'model/Constants',
        'model/Events',
        'knockout',
        'worldwind'], function (
    ...
    ko) {
        ...
        var Globe = function (wwd, options) {
            ...
            // this.wwd.globe = new Globe("globe-canvas");
            ...
            this.layerManagerHelper = new LayerManagerHelper();
            ...
            var bmngImageLayer = new WorldWind.BMNGRestLayer(null, "/standalonedata/Earth/BlueMarble256/");
            bmngImageLayer.minActiveAltitude = 0; // default setting is 3e6;
            // wwd.addLayer(bmngImageLayer);
            // bmngImageLayer = new WorldWind.BMNGOneImageLayer();
            var coordlayer = new CoordinatesDisplayLayer(wwd);
            // bmngImageLayer.minActiveAltitude = 0; // default setting is 3e6;
            ...
            if (showWidgets || showWidgets === undefined) {
                ...
                widgets.addRenderable(new LocationWidget(this,this.wwd));
    ...
    Globe.prototype.getlayermanager = function()
    {
        var self = this;
        return self.layerManager;
    }
        /**
         *
         * @param {Date} time
...
//                    eyePoint = navigatorState.eyePoint,
        ...
        Globe.prototype.resetHeadingAndTilt = function () {
            ...
            this.wwd.navigator.lookAtLocation.latitude = config.startupLatitude;
            this.wwd.navigator.lookAtLocation.longitude = config.startupLongitude;
            this.wwd.navigator.range = config.startupAltitude;
