...
define([
    ...
    ww) {
        ...
        var LocationWidget = function (globe, wwd) {
...
//                    WorldWind.OFFSET_INSET_PIXELS, BOTTOM_MARGIN + DIAL_MARGIN + DIAL_RADIUS),
                latOffset = new WorldWind.Offset(
                    WorldWind.OFFSET_INSET_PIXELS, 60,
                    WorldWind.OFFSET_PIXELS, BOTTOM_MARGIN + 50),
                ...
                slpOffset = new WorldWind.Offset(
                    ...
                    WorldWind.OFFSET_PIXELS, BOTTOM_MARGIN - 25),
                headingOffset = new WorldWind.Offset(
                    WorldWind.OFFSET_INSET_PIXELS,DIAL_ORIGIN_X+65,
                    WorldWind.OFFSET_PIXELS, BOTTOM_MARGIN-10  ),
                tiltOffset = new WorldWind.Offset(
                    WorldWind.OFFSET_INSET_PIXELS,DIAL_ORIGIN_X-15,
                    WorldWind.OFFSET_PIXELS, BOTTOM_MARGIN-10  ),
            ...
            this.headingtext = new WorldWind.ScreenText(latOffset, "Heading");
            this.headingtext.attributes = new WorldWind.TextAttributes(textAttr);
            this.headingtext.alwaysOnTop = true;
            this.headingtext.attributes = textAttr;
            ...
            // Text
            // Common Attributes
            textAttr.color = WorldWind.Color.YELLOW;
            textAttr.font = new WorldWind.Font(14);
            ...
            this.tilttext = new WorldWind.ScreenText(tiltOffset, "Tilt");
            this.tilttext.attributes = new WorldWind.TextAttributes(textAttr);
            this.tilttext.alwaysOnTop = true;
            this.tilttext.attributes = textAttr;
        ...
        LocationWidget.prototype.updateLocationText = function () {
            //
            this.headingtext.text =  formatter.formatAngle360((this.wwd.navigator.heading-this.wwd.navigator.heading-this.wwd.navigator.heading), 1);
            // this.tilttext.text = "Tilt: " + formatter.formatAngle180(this.wwd.navigator.tilt, 1);
...
//                heading = dc.navigatorState.heading || 0.001,
            ...
            // this.headingtext.imageRotation = heading;
            ...
            // }
            this.headingtext.render(dc);
            // this.tilttext.render(dc);
