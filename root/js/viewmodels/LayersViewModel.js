...
define([
    ...
    function (constants, log, dragula, ko, $) {
        ...
        function LayersViewModel(globe, viewFragment, appendToId) {
            ...
            this.imageLayers = layerManager.imageLayers;
            this.polygonLayers = layerManager.polygonLayers;
            ...
            this.serverAddresses = ko.observableArray([
                ...
                // {name: "NASA Earth Observations", url: "https://map1.vis.earthdata.nasa.gov/wmts-geo/1.0.0/WMTSCapabilities.xml"},
...
//                {name: "SAEON", url: "./customdata/ows.xml"},
//                 {name: "SAEON0", url: "http://app01.saeon.ac.za:8080/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
//                 {name: "SAEON1", url: "http://app01.saeon.ac.za:8081/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
//                 {name: "SAEON2", url: "http://app01.saeon.ac.za:8082/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
//                 {name: "SAEON3", url: "http://app01.saeon.ac.za:8083/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
//                 {name: "SAEON4", url: "http://app01.saeon.ac.za:8084/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
                // {name: "SAEON5", url: "http://app01.saeon.ac.za:8084/geoserver/ows?version=1.3.0&service=WMS&request=GetCapabilities"},
//                {name: "GEOMac Wildfire Support", url: "https://wildfire.cr.usgs.gov/arcgis/services/geomac_dyn/MapServer/WMSServer"}
            ...
            this.polygonLayersCount = ko.observable(this.polygonLayers().length);
            this.polygonLayers.subscribe(function (changes) {
                this.polygonLayersCount(this.polygonLayers().length);
            }, this, "change");
            ...
            this.imageLayersCount = ko.observable(this.imageLayers().length);
            this.imageLayers.subscribe(function (changes) {
                this.imageLayers(this.imageLayers().length);
            }, this, "change");
...
//                dialog.open(layer);
            ...
            this.onDropLayer = function (dropped, target, source, sibling) {
                ...
                }else if (source.id === 'polygon-layers-item-container') {
                ...
                else if (source.id === 'image-layers-item-container') {
                    layers = self.imageLayers;
                }
            ...
            this.drake.containers.push(document.getElementById('polygon-layers-item-container'));
