...
define(['model/Constants',
        ...
        'worldwind'],
    function (constants, ko, $, moment,CoordinatesDisplayLayer) {
        ...
        function SettingsViewModel(globe, viewFragment, appendToId) {
            var self = this,
                ...
                tessellation, frameStatistics, coordlayer;
            ...
            coordlayer = this.layerManager.findLayer("Coordinates");//new CoordinatesDisplayLayer( this.globe.wwd);
            ...
            this.coordsEnabled = coordlayer ? coordlayer.enabled : ko.observable();
